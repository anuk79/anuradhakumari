    ...
    <header role="banner" className="px-4 sm:px-10 lg:px-28 py-6 sticky top-0 z-10 text-lg">
       <a href="#main-content" className="skip-to-main-link">
        ...
        <Head>
          ...
          <meta name="description" content="My name is Anuradha Kumari. I am a senior frontend developer based in the Netherlands, working on making the web accessible, one website at a time." />
          ...
          <meta name="og:description" content="Senior frontend developer, making the web accessible - one website at a time." />
